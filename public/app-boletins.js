...
function _renderLinhaContratoPainel(c, idx, mes) {
  ...
  if (!bol) {
    ...
    acoes = `<div style="display:flex;gap:4px;justify-content:center;flex-wrap:wrap">${btnPreview}${btnAjustar}${btnAprovar}${btnDesfazer}${btnEmitir}${btnReabrir}${btnPacote}</div>`;
  }
